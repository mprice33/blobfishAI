...
train_features_inception = get_bottleneck_features(inception_model, train_imgs_scaled)
validation_features_inception = get_bottleneck_features(inception_model, validation_imgs_scaled)

print('Train Bottleneck Features:', train_features_inception.shape,
      '\tValidation Bottleneck Features:', validation_features_inception.shape)
...
history = model.fit(x=train_features_inception, y=train_labels_enc,
...
t = f.suptitle('Transfer learning model 4 CNN Performance', fontsize=12)
...
model.save('Transfer_Learning_zoo_cnn_4.h5')