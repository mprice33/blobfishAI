# Addition of image augmentation to see the result, uses datagenerator stream instead of regular images input
...
train_generator = train_datagen.flow(train_imgs, train_labels_enc, batch_size=75)
...
history = model.fit_generator(train_generator, steps_per_epoch=150, epochs=200,
...
ax2.set_xticks(np.arange(0, 201, 5))
...
model.save('simple_zoo_base_cnn_250_250_150Step_150Epoch_50Batch_with_image_gen.h5')