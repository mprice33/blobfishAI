...
# Identify target directories for training/validation images
...
# declare specs related to training
batch_size = 30
num_classes = 8
epochs = 30
...
t = f.suptitle('Basic model 1 CNN Performance', fontsize=12)
...
#Save model
model.save('simple_zoo_base_cnn_1.h5')