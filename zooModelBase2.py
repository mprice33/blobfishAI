# Different attempt from base model 1, same structure and format
...
t = f.suptitle('Basic model 2 CNN Performance', fontsize=12)
...
model.save('simple_zoo_base_cnn_2.h5')